...
const Project = () => {
        ...
        <main className='h-screen w-screen flex'>
            <section className="left relative flex flex-col h-screen min-w-96 bg-slate-300">
                ...
                <div className="conversation-area flex flex-col h-full relative">
                    <div
                        ref={messageBox}
                        className="message-box flex-grow flex flex-col gap-2 overflow-y-auto px-2 pt-16 pb-20 scrollbar-hide">
                        {messages.map((msg, index) => (
                            <div  key={index}
  className={`
    ${msg.sender._id === user._id.toString() 
      ? 'bg-blue-200 text-black self-start'   // Your messages
      : 'bg-green-200 text-black self-end ml-auto'} // Others' messages
  ...
  `}>
                    ...
                    <div className="inputField w-full flex absolute bottom-0 bg-white border-t">
                        <input
                            ...
                            className='p-5 px-1 border outline-none flex-grow' type="text" placeholder='Enter message' />
                        <button
                            onClick={send}
  ...
  className='mt-6 px-4 py-2 bg-blue-600 left 1/2 text-white rounded-md mx-auto'>
  Add Collaborators
</button>
